...
namespace QuikTrade.ViewModels.Commands
{
   ...
   public partial class ViewModelCommands
   {
      ...
      internal static void CloseAllTabs(object sender, RoutedEventArgs e)
      {
      ...
      /// <param name="sender">Объект, создавший событие.</param>
      /// <param name="e">Аргументы события.</param>
      internal static void CloseOtherSameTabs(object sender, RoutedEventArgs e)
      {
         TabItem tabItem = GetTabItem(e);

         if (tabItem != null)
         {
            string logMsg = $"Другие вкладки типа [{tabItem.DataContext.GetType().Name}] закрыты.";
      ...
      /// <param name="sender">Объект, создавший событие.</param>
      /// <param name="e">Аргументы события.</param>
      internal static void CloseAllSameTabs(object sender, RoutedEventArgs e)
      {
         // ищем родительскую вкладку
         TabItem tabItem = GetTabItem(e);
         ...
         if (tabItem != null)
         {
            string logMsg = $"Все вкладки типа [{tabItem.DataContext.GetType().Name}] закрыты.";
      ...
      internal static void CloseOtherTabs(object sender, RoutedEventArgs e)
      {
         ...
         if (tabItem != null)
         {
            string logMsg = $"Все вкладки кроме активной закрыты.";
