...
namespace QuikTrade.Utilities.Converters
{
   ...
   public class BooleanAndToVisibilityConverter : IMultiValueConverter
   {
      ...
      /// <summary>
      /// Инициализирует новый экземпляр класса <see cref="BooleanAndToVisibilityConverter"/>
      /// </summary>
      ...
      /// <returns>Значение перчисления <see cref="Visibility"/> как результат логического умножения над элементами массива .</returns>
